...
import roupas.User;
import DAOs.UserDAO; // For instantiation, until a proper DI mechanism is in place
import Repository.UserRepository;
import javax.swing.JOptionPane;
import java.sql.SQLException; // For catching exception from repository methods
...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public TelaLogin() {
        initComponents();
        this.userRepository = new UserDAO(); // Initialize the repository
    }
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        try {
            User usuarioEncontrado = userRepository.buscarPorEmail(email);
